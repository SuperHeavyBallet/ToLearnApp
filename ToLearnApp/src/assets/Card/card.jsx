...
export default function Card( { timeCreated, cardCompleted, cardTitle, cardPriority, cardText, onRemove, onChangeCompleted, onWorkingOnIt})
{
        ...
        <div className={styles.card}>
            ...
            <div className={styles.inputEditBlock}>
                ...
                <svg 
                    ...
                    className={styles.editCog} fill="#00008b" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg" >
